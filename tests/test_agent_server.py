...
class AgentServerTests(unittest.TestCase):
    ...
    def test_agent_page_serves_chat_ui(self) -> None:
        ...
        try:
            ...
            self.assertIn("explain 调试", html)
            self.assertIn("返回内容", html)
            self.assertIn("Retrieval 返回内容", html)
    ...
    def test_agent_chat_uses_memory_retrieval_model_and_assistant_write(self) -> None:
        ...
        try:
            ...
            self.assertEqual(FakeEchoMemoryHandler.calls[3]["payload"].get("include_debug"), True)
    ...
    def test_agent_context_previews_messages_without_model_or_message_writes(self) -> None:
        ...
        try:
            ...
            self.assertEqual(FakeEchoMemoryHandler.calls[2]["payload"].get("include_debug"), True)
